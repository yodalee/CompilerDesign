...
typedef enum TokenType { FloatDeclaration, IntegerDeclaration, PrintOp, AssignmentOp, PlusOp, MinusOp, MulOp, DivOp, Alphabet, IntValue, FloatValue, EOFsymbol } TokenType;
...
typedef struct Value{
    ValueType type;
    union{
        char id[257];                   /* if the node represent the access of the identifier */
...
typedef struct Statement{
    StmtType type;
    union{
        char variable[257];              /* print statement */
